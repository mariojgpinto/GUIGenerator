...
public class GUI_HomeMenu1 : MonoBehaviour {
	...
	public static GameObject				imageSlideShow_buttons_next_text_Other_1_gameObject;
	...
	public static GameObject				imageSlideShow_buttons_previous_text_Other_2_gameObject;
	...
	public static GameObject				imageSlideShow_buttons_back_text_Other_3_gameObject;
	...
	public static GameObject				input_name_placeholder_Other_4_gameObject;

	public static GameObject				input_name_text_Other_5_gameObject;
	...
	public static GameObject				input_email_placeholder_Other_6_gameObject;

	public static GameObject				input_email_text_Other_7_gameObject;
	...
	public static void UpdateValues(GameObject panel){
		...
		imageSlideShow_buttons_next_text_Other_1_gameObject = imageSlideShow_buttons_next_Button_gameObject.transform.Find("Text").gameObject;
		...
		imageSlideShow_buttons_previous_text_Other_2_gameObject = imageSlideShow_buttons_previous_Button_gameObject.transform.Find("Text").gameObject;
		...
		imageSlideShow_buttons_back_text_Other_3_gameObject = imageSlideShow_buttons_back_Button_gameObject.transform.Find("Text").gameObject;
		...
		input_name_placeholder_Other_4_gameObject = input_name_InputField_gameObject.transform.Find("Placeholder").gameObject;

		input_name_text_Other_5_gameObject = input_name_InputField_gameObject.transform.Find("Text").gameObject;
		...
		input_email_placeholder_Other_6_gameObject = input_email_InputField_gameObject.transform.Find("Placeholder").gameObject;

		input_email_text_Other_7_gameObject = input_email_InputField_gameObject.transform.Find("Text").gameObject;
