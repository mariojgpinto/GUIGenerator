...
public class GUI_HomeMenu2 : MonoBehaviour {
	...
	public static GameObject				imageSlideShow_buttons_next_text_Other_29_gameObject;
	...
	public static GameObject				imageSlideShow_buttons_previous_text_Other_30_gameObject;
	...
	public static GameObject				imageSlideShow_buttons_back_text_Other_31_gameObject;
	...
	public static GameObject				input_name_placeholder_Other_32_gameObject;

	public static GameObject				input_name_text_Other_33_gameObject;
	...
	public static GameObject				input_email_placeholder_Other_34_gameObject;

	public static GameObject				input_email_text_Other_35_gameObject;
	...
	public static void UpdateValues(GameObject panel){
		...
		imageSlideShow_buttons_next_text_Other_29_gameObject = imageSlideShow_buttons_next_Button_gameObject.transform.Find("Text").gameObject;
		...
		imageSlideShow_buttons_previous_text_Other_30_gameObject = imageSlideShow_buttons_previous_Button_gameObject.transform.Find("Text").gameObject;
		...
		imageSlideShow_buttons_back_text_Other_31_gameObject = imageSlideShow_buttons_back_Button_gameObject.transform.Find("Text").gameObject;
		...
		input_name_placeholder_Other_32_gameObject = input_name_InputField_gameObject.transform.Find("Placeholder").gameObject;

		input_name_text_Other_33_gameObject = input_name_InputField_gameObject.transform.Find("Text").gameObject;
		...
		input_email_placeholder_Other_34_gameObject = input_email_InputField_gameObject.transform.Find("Placeholder").gameObject;

		input_email_text_Other_35_gameObject = input_email_InputField_gameObject.transform.Find("Text").gameObject;
